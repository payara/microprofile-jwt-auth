...
/**
 * Validate that mp.jwt.verify.publickey.location property values of type remote URL to a PEM
 * work to validate the JWT which is signed with privateKey4k.pem
 */
